...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/pymatsolver-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=7537&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pymatsolver-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `pymatsolver` can be installed with:

```
conda install pymatsolver
```

It is possible to list all of the versions of `pymatsolver` available on your platform with:
